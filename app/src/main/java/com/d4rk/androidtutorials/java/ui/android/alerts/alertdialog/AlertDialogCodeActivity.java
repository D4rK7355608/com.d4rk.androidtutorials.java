...
public class AlertDialogCodeActivity extends AppCompatActivity {
    ...
    private void setupViewPager() {
        ...
        adapter.addFragment(new AlertDialogTabCodeFragment(), getString(R.string.code_java));
        adapter.addFragment(new AlertDialogTabLayoutFragment(), getString(R.string.layout_xml));
