...
public class StartupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonBrowsePrivacyPolicyAndTermsOfService.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://sites.google.com/view/d4rk7355608/more/apps/privacy-policy"))));
        binding.floatingButtonAgree.setOnClickListener(v -> startActivity(new Intent(this, MainActivity.class)));
