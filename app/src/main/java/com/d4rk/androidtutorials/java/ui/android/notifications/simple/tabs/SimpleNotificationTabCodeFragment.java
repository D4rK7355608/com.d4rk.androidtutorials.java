...
public class SimpleNotificationTabCodeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.text_simple_notification_java);
