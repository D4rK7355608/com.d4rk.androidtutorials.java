package com.d4rk.androidtutorials.java.ui.android.buttons.switches.tabs;
...
public class SwitchTabCodeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.text_toggle_java);
