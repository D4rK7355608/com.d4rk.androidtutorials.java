package com.d4rk.androidtutorials.java.ui.android.notifications.inbox.tabs;
...
public class InboxNotificationTabCodeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        InputStream inputStream = getResources().openRawResource(R.raw.text_inbox_notification_java);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Typeface monospaceFont = switch (preference.getString(getString(R.string.key_monospace_font), "0")) {
