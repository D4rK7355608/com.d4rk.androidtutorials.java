...
public final class ActivityAlertDialogBinding implements ViewBinding {
  ...
  private ActivityAlertDialogBinding(@NonNull ConstraintLayout rootView,
  ...
  public static ActivityAlertDialogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_alert_dialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityAlertDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAlertDialogBinding((ConstraintLayout) rootView, button,
