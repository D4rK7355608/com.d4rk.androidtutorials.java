...
public final class ActivityShortcutsBuildBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityShortcutsBuildBinding(@NonNull ConstraintLayout rootView, @NonNull AdView adView,
  ...
  @NonNull
  public static ActivityShortcutsBuildBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityShortcutsBuildBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_shortcuts_build, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityShortcutsBuildBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityShortcutsBuildBinding((ConstraintLayout) rootView, adView, cardViewAd,
