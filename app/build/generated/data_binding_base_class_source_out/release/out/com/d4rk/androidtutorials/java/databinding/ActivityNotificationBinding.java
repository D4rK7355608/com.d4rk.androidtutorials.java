...
public final class ActivityNotificationBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton buttonShowNotification;
  ...
  private ActivityNotificationBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton buttonShowNotification,
      @NonNull ExtendedFloatingActionButton floatingButtonShowSyntax) {
    this.rootView = rootView;
    this.buttonShowNotification = buttonShowNotification;
  ...
  public static ActivityNotificationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.button_show_notification;
      MaterialButton buttonShowNotification = ViewBindings.findChildViewById(rootView, id);
      if (buttonShowNotification == null) {
        break missingId;
      }
      ...
      return new ActivityNotificationBinding((ConstraintLayout) rootView, buttonShowNotification,
