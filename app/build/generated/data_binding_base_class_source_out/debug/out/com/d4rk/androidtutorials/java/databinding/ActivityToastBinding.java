...
public final class ActivityToastBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityToastBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton button,
  ...
  @NonNull
  public static ActivityToastBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityToastBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_toast, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityToastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityToastBinding((ConstraintLayout) rootView, button,
